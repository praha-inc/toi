...
[![license](https://img.shields.io/badge/License-MIT-green.svg)](https://github.com/praha-inc/toi/blob/main/packages/toi/LICENSE)
...
The logo keeps the picture: the gate drawn in ink, and the mouth replaced by a vermillion seal — the answer already stamped and waiting inside. Read the full story in [What "toi" Means](https://praha-inc.github.io/toi/guide/start/name).
...
This project is [```MIT```](https://github.com/praha-inc/toi/blob/main/packages/toi/LICENSE) licensed.
